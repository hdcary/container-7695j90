...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-7695j90.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-7695j90.containers.anotherwebservice.com/
...
```
git clone git@github.com:hdcary/container-7695j90.git
cd container-7695j90
```
...
```
docker attach container-7695j90
```
